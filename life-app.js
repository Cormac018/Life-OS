...
function validateWorkspaceLinks(payload) {
  ...
  return { ok: true };
    ...
    window.LifeOSApp=Object.freeze({get version(){return 'v61';},snapshot:captureWorkspace,restore:async data=>LifeOSRuntime.restoreBackup({format:'lifeos-backup/2',workspace:data}),domains:()=>workspaceParts(),capture:CaptureDemo,captureTargets:CaptureTargetsDemo,save:()=>LifeOSRuntime.flush()});
