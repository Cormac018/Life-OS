...
(function(global){
  ...
  const starters=new Set(['profile','day-options','save-preview','add-slot','edit-slot','pin-slot','cancel-slot','status','done-slot','plan-week','plan-day','move-slot','alternative-slot','routine-new','routine-edit','routine-status']);
