...
(function () {
  ...
  // Delegates to the canonical writer. The patch is forwarded whole rather
  // than destructured, because the writer needs to see which keys were
  // actually supplied in order to leave the others unchanged.
  function upsertLog(patch) {
    return window.LifeOSWrite.workLog(patch);
  }
