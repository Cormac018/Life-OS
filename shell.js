...
(function () {
  ...
  // "rig" is the ops proving rig. It is deliberately absent from the nav and
  // from titleMap below, which falls back to "Life OS": the route exists only
  // for someone who types #rig. Without this entry getRoute would fall through
  // to "today" and #view-rig could never activate.
  const ROUTES = ["today", "workouts", "metrics", "goals", "plan", "work", "finances", "journal", "people", "rig"];
